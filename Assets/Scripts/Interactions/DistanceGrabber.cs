...
public class DistanceGrabber : MonoBehaviour
{
    ...
    private void HandleGrab()
    {
        ...
        {
            UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable interactable = hitInfo.collider.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>();
            ...
            if (interactable != null)
            {
                ...
                {
                    rayInteractor.StartManualInteraction(interactable as UnityEngine.XR.Interaction.Toolkit.Interactables.IXRSelectInteractable);
