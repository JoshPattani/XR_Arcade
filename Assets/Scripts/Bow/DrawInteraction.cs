...
/// </summary>
public class DrawInteraction : UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable
{ 
    ...
    private void HapticFeedback()
    {
        ...
        if (pullingInteractor is UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInputInteractor controllerInteractor)
        {
