...
public class BowDraw : UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable
{
    ...
    private UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor pullingInteractor;

    protected override void OnSelectEntered(SelectEnterEventArgs args)
    {
        base.OnSelectEntered(args);
        // Start pulling the bowstring
        pullingInteractor = args.interactorObject as UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor;
    }
    ...
    private void FireArrow()
    {
        ...
        rb.linearVelocity = bowstring.forward * pullAmount * 20f; // Adjust force multiplier as needed
    }
}
